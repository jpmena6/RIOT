...
WEAK_DEFAULT void isr_ltc(void);
...
WEAK_DEFAULT void isr_radio_int0(void);
WEAK_DEFAULT void isr_radio_int1(void);
...
WEAK_DEFAULT void isr_tpm3(void);
WEAK_DEFAULT void isr_trng0an(void);
