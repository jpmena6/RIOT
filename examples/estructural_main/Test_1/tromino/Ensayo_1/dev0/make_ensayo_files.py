...
def make_file_tromino(dataname,name_procesed_txt):
	...
	list_e = list()
	t = 0
	with open("EqualizedFile.dat", "r") as f:
		[f.readline() for i in range(38)] # headers
		line = f.readline()
		while line != "":
			list_line = line.split(" ")
			list_x.append(float(list_line[7]))
			list_y.append(float(list_line[6]))
...
if __name__ == "__main__":
	make_file_tromino("EqualizedFile.dat", "tromino_Ensayo_1_dev0")
